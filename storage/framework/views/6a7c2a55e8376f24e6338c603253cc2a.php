...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'CampusConnect Pro'); ?></title>
...
<div class="flex min-h-screen">
    ...
    <aside class="w-72 bg-[#151b2d] border-r border-white/10 fixed left-0 top-0 bottom-0 overflow-y-auto">
        ...
        <nav class="p-4 space-y-6">
            ...
            <div>
                ...
                <a href="<?php echo e(route('marketplace.index')); ?>" class="nav-link">Browse Items</a>
                <a href="<?php echo e(route('marketplace.create')); ?>" class="nav-link">Sell Item</a>
                <a href="<?php echo e(route('marketplace.my-listings')); ?>" class="nav-link">My Listings</a>
                <a href="<?php echo e(route('chat.index')); ?>" class="nav-link">Messages</a>
                <a href="<?php echo e(route('transactions.index')); ?>" class="nav-link">Transactions</a>
            </div>
            ...
            <?php if(auth()->check() && auth()->user()->is_admin): ?>
                <div>
                    ...
                    <a href="<?php echo e(route('admin.dashboard')); ?>" class="nav-link-admin">
                        Fraud Detection
                    </a>

                    <a href="<?php echo e(route('admin.items')); ?>" class="nav-link">
                        Flagged Items
                    </a>
                </div>
            <?php endif; ?>
    ...
    <main class="ml-72 flex-1">
        ...
        <header class="h-20 bg-[#151b2d] border-b border-white/10 flex items-center justify-between px-8">
            <h2 class="text-xl font-bold"><?php echo $__env->yieldContent('page_title'); ?></h2>
...
</html><?php /**PATH C:\Users\nahid\Downloads\campus-connect-pro-complete-20-features-v2-fixed\campus-connect-pro-complete-20-features-v2-fixed\campus-connect-pro-complete\resources\views/layouts/app.blade.php ENDPATH**/ ?>